  ...
  return props.trigger ? (
    <div className="popup fixed flex top-0 left-0 w-full h-screen justify-center items-center">
      <div className="popup-inner relative bg-white w-full max-w-2xl ">
        ...
        <div trigger={buttonDeleteGroup} setTrigger={setButtonDeleteGroup}>
          ...
          <div className="modal-body relative p-4">
            <div className="text-center text-xl mt-3">
              <i className="fa-solid fa-triangle-exclamation fa-xl text-red-600"></i>{' '}
              This action is permanent...{' '}
            </div>

            <div className="mt-6 text-center">
              Are you sure you want to delete: USER CREATED
            </div>
