        ...
        <div trigger={buttonEditField} setTrigger={setButtonEditField}>
          ...
          <div className="modal-body relative p-4">
            ...
            <div className="grid grid-cols-3 grid-rows-6 gap-3 mt-2 ml-4">
              ...
              <div className="col-span-2">
                <input
                  ...
                  className=" text-sm mt-1 pl-1 appearance-none rounded block w-4/5 border border-grey-500 shadow-sm focus:outline-none focus:border-dark-blue focus:ring-dark-blue focus:ring-0 focus:drop-shadow-blue"
                ></input>
              </div>

              <div className="col-span-1 flex text-sm content-around">
                Scope:{' '}
              </div>
              <select
                className="col-span-2 text-sm mt-1 rounded block w-4/5 border border-grey-500 shadow-sm focus:outline-none focus:border-dark-blue focus:ring-dark-blue focus:ring-0"
              ...
              <div className="col-span-1 flex text-sm content-around">
                Field Type:{' '}
                <button
                  onClick={() => setButtonFieldTypeInfo(true)}
              ...
              <div className="col-span-1 flex text-sm content-around">
                Field Group:{' '}
                <button
                  onClick={() => setButtonFieldGroupInfo(true)}
                  className="ml-1 text-dark-blue"
                >
                  <i class="fa-solid fa-circle-info"></i>
                </button>{' '}
              ...
              <input
                ...
                name="quickSearch"
                value="quick"
                class="col-span-1 border-1 border-grey-300 shadow-sm h-3.5 w-3.5 mt-2"
              />
              <div className="col-span-2 flex text-sm content-around">
                Quick Search
              </div>
              ...
              />
              <div className="col-span-2 flex text-sm content-around">
                Include Family (tagging){' '}
                <button
                  onClick={() => setButtonFamilyTaggingInfo(true)}
                  className="ml-1 text-dark-blue"
                >
                  <i class="fa-solid fa-circle-info"></i>
                </button>
            ...
            <div className="grid grid-cols-2 grid-rows-1 gap-3 mt-2 ml-4">
              <div className="col-span-1 flex text-sm mt-3">
                Assign Keyboard Hot Key:{' '}
              </div>
              <div className="col-span-1 block">
                <input
                  ...
                  className="justify-center text-sm mt-1 pl-1 ml-10 appearance-none rounded block w-6 border border-grey-500 shadow-sm focus:outline-none focus:border-dark-blue focus:ring-dark-blue focus:ring-0 focus:drop-shadow-blue"
                ></input>
              </div>
            </div>
            <div className="text-xs text-gray-400 text-center ml-32">
              Available Characters (lowercase only):
              <br /> a b c d e f g h i j k l m n o p q r s t u v w x y z 1 2 3 4
              5 6 7 8 9 0
            </div>
                ...
                <div className="place-content-center flex mt-2">
                  ...
                  <div className="ml-2 flex">
                    <input
                      type="text"
                      maxLength={250}
                      className=" text-sm mt-1 pl-1 w-80 mr-7 appearance-none rounded block border border-grey-500 shadow-sm focus:outline-none focus:border-dark-blue focus:ring-dark-blue focus:ring-0 focus:drop-shadow-blue"
                    ></input>
                  </div>
                </div>
            ...
            <div className="flex justify-between mt-8">
              <button
                onClick={() => setButtonDeleteField(true)}
                className="rounded border border-grey-200 py-1 px-2.5 text-red-600 shadow-sm focus:outline-none focus:border-dark-blue focus:ring-dark-blue focus:ring-0"
              >
                {' '}
                Delete Field{' '}
              </button>
            ...
            <FieldTypeInfo
              trigger={buttonFieldTypeInfo}
              setTrigger={setButtonFieldTypeInfo}
            />
            <FieldGroupInfo
              trigger={buttonFieldGroupInfo}
              setTrigger={setButtonFieldGroupInfo}
            />
            <FamilyTaggingInfo
              trigger={buttonFamilyTaggingInfo}
              setTrigger={setButtonFamilyTaggingInfo}
            />
          </div>
        </div>

        <DeleteField
          trigger={buttonDeleteField}
          setTrigger={setButtonDeleteField}
        />
        {props.children}
      </div>
    </div>
